...
<head>
    ...
    <!-- inject:css-->
    <link rel="stylesheet" href="{{ asset('../user/assets/vendor/css/bootstrap/bootstrap.css') }}">
...
<body class="geex-dashboard">
    ...
    <header class="geex-header">
        <div class="geex-header__wrapper">
            <div class="geex-header__logo-wrapper">
                <a class='geex-header__logo' href='/'>
                    <img class="logo-lite" src="{{ logo }}" alt="Header logo" />
                    <img class="logo-dark" src="{{ logo }}" alt="Header logo" />
                </a>
            </div>
            <nav class="geex-header__menu-wrapper">
                <ul class="geex-header__menu">
                    <li class="geex-header__menu__item has-children">
                        ...
                        <ul class="geex-header__submenu">
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('index') }}'>Dashboard</a>
                            </li>
                    ...
                    <li class="geex-header__menu__item has-children">
                        <a href="{{ route('profile-update') }}" class="geex-header__menu__link">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <ul class="geex-header__submenu">
                            <li class="geex-header__menu__item">
                                <a href="{{ route('profile-update') }}"
                                    class="geex-header__menu__link geex-customizer__btn--top">Profile Update</a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a href="{{ route('bank-detail-update') }}"
                                    class="geex-header__menu__link geex-customizer__btn--top">Bank Details Update</a>
                            </li>
                    ...
                    <li class="geex-header__menu__item has-children">
                        ...
                        <ul class="geex-header__submenu">
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('activate-account') }}'>Activate
                                    Account</a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link'
                                    href='{{ route('activation_history') }}'>Activation
                                    History</a>
                            </li>
                    ...
                    <li class="geex-header__menu__item has-children">
                        ...
                        <ul class="geex-header__submenu">
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('request_fund') }}'>Request Fund
                                </a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('fund_history') }}'>Request Fund
                                    History
                                </a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link'
                                    href='{{ route('income-to-ewallet-transfer') }}'>Income To
                                    Wallet Transfer

                                </a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('income-transfer') }}'>Income
                                    Transfer
                                </a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('wallet-transfer') }}'>Wallet
                                    Transfer
                                </a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('wallet_ledger') }}'>Wallet Ladger
                                </a>
                            </li>
                    ...
                    <li class="geex-header__menu__item has-children">
                        ...
                        <ul class="geex-header__submenu">
                            ...
                            @foreach ($incomes as $key => $income)
                                <li class="geex-header__menu__item">
                                    <a class='geex-header__menu__link'
                                        href='{{ route('userincome', ['type' => $key]) }}'>{{ $income }}
                                    </a>
                                </li>
                            @endforeach
                    ...
                    <li class="geex-header__menu__item has-children">
                        ...
                        <ul class="geex-header__submenu">
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('withdraw') }}'>Withdraw
                                </a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('withdraw_history') }}'>Withdraw
                                    History
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="geex-header__menu__item has-children">
                        ...
                        <ul class="geex-header__submenu">
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link'
                                    href='{{ route('tree', ['user_id' => $userinfo['user_id']]) }}'>Team Tree
                                </a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('levelreport') }}'>Level Report
                                </a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('my_directs') }}'>My Directs
                                </a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('my-downline-team') }}'>Total Team
                    ...
                    <li class="geex-header__menu__item has-children">
                        ...
                        <ul class="geex-header__submenu">
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('user-support') }}'>Compose
                                    mail</a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('user-inbox-report') }}'>Inbox
                                    mail</a>
                            </li>
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('user-outbox-report') }}'>Outbox
                                    mail</a>
                            </li>
                    ...
                    <li class="geex-header__menu__item has-children">
                        ...
                        <ul class="geex-header__submenu">
                            <li class="geex-header__menu__item">
                                <a class='geex-header__menu__link' href='{{ route('reset_passaword') }}'>Reset
                                    Password</a>
                            </li>
                    ...
                    <li class="geex-header__menu__item has-children">
                        <a href="{{ route('logout') }}" class="geex-header__menu__link">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_1141_9723)">
                                    <path
        ...
        <div class="geex-sidebar">
            ...
            <div class="geex-sidebar__wrapper">
                <div class="geex-sidebar__header">
                    <a class='geex-sidebar__logo' href='#'>
                    ...
                    <ul class="geex-sidebar__menu">
                        <li class="geex-sidebar__menu__item has-children">
                            ...
                            <ul class="geex-sidebar__submenu">
                                <li class="geex-sidebar__menu__item">
                                    <a class='geex-sidebar__menu__link' href='{{ route('index') }}'>Dashboard</a>
                                </li>
                        ...
                        <li class="geex-sidebar__menu__item has-children">
                            ...
                            <ul class="geex-sidebar__submenu">
                                <li class="geex-sidebar__menu__item">
                                    <a href="{{ route('profile-update') }}"
                                        class="geex-sidebar__menu__link geex-customizer__btn--top">Profile
                                        Update</a>
                                </li>
                                <li class="geex-sidebar__menu__item">
                                    <a href="{{ route('bank-detail-update') }}"
                                        class="geex-sidebar__menu__link geex-customizer__btn--top">Bank
                                        Details Update</a>
                                </li>
                            ...
                            <ul class="geex-sidebar__submenu">
                                <li class="geex-sidebar__menu__item">
                                    <a class='geex-sidebar__menu__link'
                                        href='{{ route('activate-account') }}'>Activate Account</a>
                                </li>
                        ...
                        <li class="geex-sidebar__menu__item has-children">
                            ...
                            <ul class="geex-sidebar__submenu">
                                <li class="geex-sidebar__menu__item">
                                    <a class='geex-sidebar__menu__link' href='/chart'>Chart</a>
                                </li>
                        ...
                        <li class="geex-sidebar__menu__item has-children">
                            ...
                            <ul class="geex-sidebar__submenu">
                                <li class="geex-sidebar__menu__item">
                                    <a class='geex-sidebar__menu__link' href='{{ route('reset_passaword') }}'>Reset
                                        Password</a>
                                </li>
                        ...
                        <li class="geex-sidebar__menu__item has-children">
                            <a href="{{ route('logout') }}" class="geex-sidebar__menu__link">
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_1141_9723)">
                                        <path
                ...
                <div class="geex-sidebar__footer">
                    <span class="geex-sidebar__footer__title">{{ Auth::guard('user')->user()->name }} Dashboard</span>
        ...
        <div class="geex-content">
            <div class="geex-content__header">
                <div class="geex-content__header__content">
                    ...
                    <p class="geex-content__header__subtitle">Welcome to <span
                            class="text-primary text-uppercase">{{ Auth::guard('user')->user()->name }}</span>
                        Dashboard</p>
                    <p class="geex-content__header__subtitle">User Id : <span
                            class="text-info">{{ Auth::guard('user')->user()->user_id }}</span></p>
                </div>
                ...
                <div class="geex-content__header__action">
                    ...
                    <div class="geex-content__header__action__wrap">
                        <ul class="geex-content__header__quickaction">
                                            ...
                                            <li class="geex-content__header__popup__item">
                                                <a class="geex-content__header__popup__link" href="#">
                                                    <div class="geex-content__header__popup__item__img">
                                                        <img src="../user/assets/img/avatar/user.svg" alt="Popup Img"
                                                            class="" />
                                                    </div>
                            ...
                            <li class="geex-content__header__quickaction__item">
                                <a href="#" class="geex-content__header__quickaction__link">
                                    <img class="user-img" src="../user/assets/img/avatar/user.svg" alt="user" />
                                </a>
                                <div class="geex-content__header__popup geex-content__header__popup--author">
                                    <div class="geex-content__header__popup__header">
                                        <div class="geex-content__header__popup__header__img">
                                            <img src="../user/assets/img/avatar/user.svg" alt="user" />
                                        </div>
    ...
    <!-- inject:js-->
    <script src="../user/assets/vendor/js/jquery/jquery-3.5.1.min.js"></script>
    <script src="../user/assets/vendor/js/jquery/jquery-ui.js"></script>
    <script src="../user/assets/vendor/js/bootstrap/bootstrap.min.js"></script>
    ...
    <script>
        function copyToClipboard() {
            const input = document.getElementById('linkTxt');
            input.select();
            input.setSelectionRange(0, 99999);
            document.execCommand('copy');
            toastr.success('<span class="text-success bg-black">Copied!</span>')
        }
    </script>
</body>
